...
function Block(dim::Int, dim_out::Int; groups::Int=8)
    # TODO: Would be nice if scale_shift defaulted to nothing
    # probably a case for multiple dispatch which can't be done
